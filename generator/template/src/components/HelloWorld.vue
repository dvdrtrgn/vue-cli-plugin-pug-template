...
.hello
  ...
  p
    ...
    a(href='https://cli.vuejs.org'
      target='_blank' rel='noopener') vue-cli documentation
    | .
  ...
  ul
    ...
    li
      a(href='https://www.npmjs.com/package/vue-cli-plugin-pug'
        target='_blank' rel='noopener') pug
  h3 Essential Links
  ul
    li
      a(href='https://vuejs.org'
        target='_blank' rel='noopener') Core Docs
    li
      a(href='https://forum.vuejs.org'
        target='_blank' rel='noopener') Forum
    li
      a(href='https://chat.vuejs.org'
        target='_blank' rel='noopener') Community Chat
    li
  ...
  ul
    li
      a(href='https://router.vuejs.org'
        target='_blank' rel='noopener') vue-router
    li
    ...
    li
      a(href='https://vue-loader.vuejs.org'
        target='_blank' rel='noopener') vue-loader
    li
